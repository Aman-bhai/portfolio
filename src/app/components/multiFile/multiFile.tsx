...
const variants = {
  base: 'relative rounded-md p-4 w-[100%] max-w-[calc(100vw-1rem)] flex justify-center items-center flex-col cursor-pointer border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out',
  active: 'border-2',
  disabled:
      ...
      <div>
        <div className="flex flex-col sm:flex-row flex-wrap">
          ...
          {value?.map(({ file, progress }, i) => (
            <div
              key={i}
              className="flex h-14 gap-2 w-36 max-w-[100vw] flex-col justify-center rounded border border-gray-300 px-4 py-2"
            >
