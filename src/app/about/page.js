            ...
            <section className="px-12 sm:px-24 py-10 dark:bg-gradient-to-r from-blue-800 to-indigo-900 dark:text-indigo-100">
                ...
                <div className="about-section flex flex-col lg:flex-row my-16">
                    ...
                    <div className="about-card w-full lg:w-2/3 flex items-center flex-col pb-6">
                        <h3 className="text-3xl font-semibold mb-6 my-6 text-center">Amafe</h3>
                        <div className="about-cardIn flex flex-wrap space-y-4 sm:items-center flex-col sm:flex-row lg:px-0">
                            <Link href="mailto:ammawdqd8@gmail.com" className="sm:w-1/2 mt-4"><span className="text-black font-semibold dark:text-indigo-300">Email : </span><span>amawdqd8@gmail.com</span></Link>
                            <Link href={"tel:966433543"} className="sm:w-1/2"><span className="text-black font-semibold dark:text-indigo-300">Phone :</span><span>+91 9wrq3r363</span> </Link>
                            <Link href={"https://maps.app.goo.gl/AFzg73V9poND2v4G6"} className="sm:w-1/2"><span className="text-black font-semibold dark:text-indigo-300">Location : </span><span>Indore,M.P</span></Link>
                            ...
                            <Link href={"#"} className="sm:w-1/2"><span className="text-black font-semibold dark:text-indigo-300">DOB : </span>184252</Link>
